...
DefaultDir = os.path.join(script_location,"Backup")
modelin = os.path.join(script_location,"model.in")

#Run command file (SWATedit)
os.system(script_location+'/swat_edit.cmd')
